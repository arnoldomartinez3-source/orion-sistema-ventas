...
import { CLIENTE_VACIO as emptyForm, validarCliente, datosCliente } from '../utils/clientes'
...
export default function Clientes() {
  ...
  const guardar = async () => {
    ...
    if (error) { setAlerta(error); return }
    setGuardando(true)
    const data = { ...datosCliente(form), updatedAt: serverTimestamp() }
    try {
      if (editando) {
