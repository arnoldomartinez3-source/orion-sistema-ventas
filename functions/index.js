...
export { marcar } from './marcar.js'
export { enviarFactura } from './enviar-factura.js'
export { secretosMH } from './secretos-mh.js'
export { establecerPin } from './establecer-pin.js'
export { extraerProductos } from './extraer-productos.js'
export { verificarPinCobro } from './verificar-pin-cobro.js'